...
var _ usersvc.UseCase = (*mockUseCase)(nil)
...
func (m *mockUseCase) ConfirmUserPhotoUpload(ctx context.Context, req domain.ConfirmPhotoUploadRequest) (domain.User, error) {
